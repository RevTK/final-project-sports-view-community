		...
		<div class="withGo__content">
						...
						<c:otherwise>
							<div>
								<a class="action-button"
									href="withGo.reg.go?post_board=${param.post_board}"
			...
			<div class="products-area-wrapper gridView">
				...
				<div class="products-row">
					...
					<div class="product-cell image">
						<img
							src="https://images.chosun.com/resizer/WPjSD1gKAN2606nVBIPn1QnVQbU=/616x0/smart/cloudfront-ap-northeast-1.images.arcpublishing.com/chosun/JDH4F64PPNIOBKMZ5MWN3XQFZU.jpg">
						<span><a style="color: black"
							href="withGo.detail.go?post_id=${p.post_id }&post_member=${p.post_member}">이정도의
								수준의 경기를! </a></span>
					</div>
					<div class="product-cell sales">
				...
				<div class="products-row">
					...
					<div class="product-cell image">
						<img
							src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Jordan_by_Lipofsky_16577.jpg/240px-Jordan_by_Lipofsky_16577.jpg">
						<span><a  style="color: black"
							href="withGo.detail.go?post_id=${p.post_id }&post_member=${p.post_member}">농구보러
								갈사람 </a></span>
					</div>
					<div class="product-cell sales">
				...
				<div class="products-row">
					...
					<div class="product-cell image">
						<img
							src="https://img.olympicchannel.com/images/image/private/f_auto/t_s_pog_staticContent_hero_xl_2x/primary/zhqlj6x592eudgh4frqz">
						<span><a  style="color: black"
							href="withGo.detail.go?post_id=${p.post_id }&post_member=${p.post_member}">배구
								보러 같이가요 </a></span>
					</div>
					<div class="product-cell sales">

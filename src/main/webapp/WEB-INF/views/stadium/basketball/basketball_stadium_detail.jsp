...
<body>
	...
	<div id="start"
		...
		<img style="display: none" id="test_3"
			src="resources/final_img_file/basketball_m/seating_chart/${seatDetail }/test_3.jpg">
		<img style="display: none" id="test_9"
			src="resources/final_img_file/basketball_m/seating_chart/${seatDetail }/test_9.jpg">
		<img style="display: none" id="test_6"
			src="resources/final_img_file/basketball_m/seating_chart/${seatDetail }/test_6.jpg">
		<img style="display: none" id="test_12"
			src="resources/final_img_file/basketball_m/seating_chart/${seatDetail }/test_12.jpg">
	</div>
	<br>
	<br>
	<br>

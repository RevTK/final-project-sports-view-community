...
<body>
	...
	<br>
	<br>
	<div style="float: left; position: absolute; left: -9%;">
		<img src="resources/files/backgroundImg/messi.png">
	</div>
	<div style="float: right; position: absolute; top: 400px; left: 75.5%;">
		<img src="resources/files/backgroundImg/ronaldo.png">
	</div>
			...
			<div class='clubEvent'>
				...
				<div>
					<span class='time'>
						...
						</c:choose> | 조회수 ${p.post_hit_count}
					</span>
				</div>
				<br> <span class='clubEventContent'>${p.post_content } </span>
				<br>

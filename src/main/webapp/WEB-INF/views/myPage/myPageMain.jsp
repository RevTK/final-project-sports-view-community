...
<body>
			...
			<div class="side-wrapper">
				<div class="side-menu">
					<a class="sidebar-link trending" href="myPage.info.go"
						style="color: black"> <svg viewBox="0 0 24 24"
							fill="currentColor">
	...
	<script>
		...
		srMyPage.reveal(`.myPage_container`, {
			origin : 'bottom'
		});
		
		srMyPage.reveal(`.myPage__bg-4`, {
			origin : 'left'
		});
		srMyPage.reveal(`.myPage__bg-3`, {
			origin : 'bottom'
		});
		srMyPage.reveal(`.myPage__bg-2`, {
			origin : 'right'
		});
		srMyPage.reveal(`.myPage__bg-1`, {
			origin : 'top'
		});
	</script>
</body>

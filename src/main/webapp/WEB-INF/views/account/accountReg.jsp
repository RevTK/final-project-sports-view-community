	...
	<h1 class="login_title">회원 가입</h1>
		<form action="account.reg.do" method="post"
			...
			<div class="accountReg__idInput-2">
				<!-- member 아이디 인풋 창 -->
				<input class="input_id" placeholder="아이디(영어,숫자 5~12)" id="idInput" name="member_id" oninput="checkId()"> 
				<input id="idConfirm" type="hidden" value="0">  <span
			...
			<div class="accountReg__pwInput-2">
				<!-- member 비밀번호 인풋 창 -->
				<input class="input_id" placeholder="비밀번호(영어,숫자,특수 7~12)" type="password" id="pwInput" name="member_pwd"> 
			</div>
			...
			<textarea class="input_content" placeholder="자기소개" name="member_intro" cols="50" rows="10"></textarea>
			<!-- member club 선택 창 -->
			<div>
